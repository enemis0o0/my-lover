               ...
               if (color.value instanceof Array) {
                    var color_selected =
                         color.value[
                              Math.floor(
                                   Math.random() *
                                        pJS.particles.color.value.length
                              )
                         ];
          ...
          switch (p.shape) {
               ...
               case "polygon":
                    pJS.fn.vendors.drawShape(
                         ...
                         p.x -
                              radius /
                                   (pJS.particles.shape.polygon.nb_sides / 3.5), // startX
          ...
          for (var i = 0; i < pJS.particles.array.length; i++) {
               ...
               if (pJS.particles.opacity.anim.enable) {
                    if (p.opacity_status == true) {
                         ...
                         if (
                              p.opacity <=
                              pJS.particles.opacity.anim.opacity_min
                         )
                         ...
                         switch (pJS.interactivity.events.onclick.mode) {
                              ...
                              case "remove":
                                   pJS.fn.modes.removeParticles(
                                        pJS.interactivity.modes.remove
                                             .particles_nb
                                   );
                                   break;
                              ...
                              case "repulse":
                                   ...
                                   }, pJS.interactivity.modes.repulse.duration *
                                        1000);
                                   break;
                         }
                    }
